...
piItem('Neocoms',3,'Biocells',10,3),
piItem('Neocoms',3,'Silicate Glass',10,3),
piItem('Nuclear Reactors',3,'Microfiber Shielding',10,3),
piItem('Nuclear Reactors',3,'Enriched Uranium',10,3),
